  ...
  export default {
    data: () => ({
      ...
      headers: [
        ...
        { text: 'policyNo', value: 'policyNo' },
        { text: 'inceptionDate', value: 'inceptionDate' },
        { text: 'payDay', value: 'payDay' },
        { text: 'policyStatus', value: 'policyStatus' },
        { text: 'pendingItems', value: 'pendingItems' },
        { text: 'notes', value: 'notes' },
        { text: 'agent', value: 'agent' },
        { text: 'Actions', value: 'firstName', sortable: false }
      ],
      customers: [],
      editedIndex: -1,
      editedItem: {
